  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 md:px-6 md:py-16">
      ...
      <div className="mt-8 flex flex-wrap gap-2">
        <Link
          href="/wisdom"
          className="rounded-full border border-gold/30 bg-gold/10 px-4 py-1.5 text-xs text-gold-light"
        >
          All
        </Link>
        {categories.map((cat) => (
          <Link
            ...
            className="rounded-full border border-border px-4 py-1.5 text-xs text-muted transition-colors hover:border-gold/30 hover:text-foreground"
          >
            {cat.name}
          </Link>
        ))}
